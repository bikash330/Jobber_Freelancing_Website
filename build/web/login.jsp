...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid py-3 px-4 navigation-container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-transparent" href="login.jsp">Login</a>
            </li>
    ...
    <div class="container login-container">
      <div class="row">
          ...
          <%
              ...
              if(error.equals("1"))
              {
                 out.println("<h3 style='color:red;text-align:center;'>Please enter correct password !! </h3>");
              }
        ...
        <div class="col-0 col-sm-6 col-md-7 login-image-container">
          <img
            src="./assets/image/Login Image.svg"
            alt="Login Image"
            class="img-fluid"
          />
        </div>
        ...
        <div class="col-12 col-sm-6 col-md-5">
          <form action="login" class="login-form" method="post">
            <div class="h4 login-title">Sign In to Jobber</div>
            <!-- Username Input -->
            <div class="field">
    ...
    <script type="module">
      ...
      import { loginMain } from "./assets/js/Controller.js";
      loginMain();
    </script>
  </body>
</html>
