      ...
      <div class="container-fluid py-3 px-4 navigation-container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-transparent" href="login.html"
                >Login</a
              >
            </li>
    ...
    <div class="container sign-up-container">
      <div class="row">
        <div class="col-6 col-sm-6 sign-up-image-container">
          ...
          <%
              String error;
              error = (String)s.getAttribute("error");
              if(error = "1")
              {
                 out.println("<h3 style:'text-color:red;'>Please type same password : </h3>")
              }
        ...
        <div class="col-12 col-sm-6">
          <form action="signUp" class="sign-up-form" method="post">
            ...
            <p class="redirect">
              Already a user? <a href="./login.html">Sign In Here.</a>
            </p>
          </form>
        </div>
      </div>
