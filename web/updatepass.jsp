    ...
    <div class="container sign-up-container">
      <div class="row">
        ...
        <div class="col-12 col-sm-6">
          ...
          <form action="updatepass" class="sign-up-form" method="post">
              
            <div class="h4 sign-up-title">Update Password Of Your Account</div>
            <!-- Username Input -->
            <!-- Password Input -->
            <div class="field">
         <%
              ...
              if(error.equals("1"))
              {
                 out.println("<h3 style='color:red;text-align:center;'>Please type Correct old  password !!</h3>");
              }
              if(error.equals("2"))
              {
              
                 out.println("<h3 style='color:red;text-align:center;'>Please type Same New password !!</h3>");
              }
         }
          ...
          %>
              ...
              <label for="newpassword" class="passwordErrorLabel"></label>
            </div>
            ...
            <div class="field">
              <label class="label">Re-confirm Password*</label>
              <div class="control has-icons-left has-icons-right">
                <input
              ...
              <label for="newpassword" class="confirmPasswordErrorLabel hide"
                >Incorrect</label
              >
            </div>
