...
<html lang="en">
  ...
  <body>
    ...
    %>
    <nav
      class="navbar navbar-expand-lg py-0 m-0 navbar-light fixed-top bg-white shadow-sm"
    >
    ...
    <div class="container-fluid" id="home-section">
      <div class="row landing-text-container">
        <div class="perfect col-12 col-sm-9 col-lg-6 shadow-lg px-3">
          <p>Hey welcome to our freelancing services!</p>
        </div>
      </div>
    </div>
    ...
    <!-- Advert Section -->
    <section class="app" id="about-us-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6" data-aos="fade-right">
            ...
            <ul>
              <li>
                <h6>
                  <span style="width: 24px;height: 24px;fill: rgb(122, 125, 133);"></span>
          ...
          <div class="col-md-6" data-aos="">
            <img
              ...
              src="./assets/image/Mobile App.jpg"
              alt=""
            />
          </div>
        </div>
...
<!-- Achievements Section -->
    ...
    <div class="acheivements-page-wrapper">
      <section class="content">
        <div class="container">
          <div class="block-title text-center">
            <h2 class="c-title">Achievements</h2>
            <hr />
          </div>
          <br />
          <br />
          <div class="row">
            <div
              class="col-lg-3 col-md-6 col-sm-6 acheivements-page-inner-wrapper"
            >
              <div
                class="single"
                style="background-image: linear-gradient(#40f5ff, #c97b7b)"
              >
                <div class="inner">
                  <h3 class="count counter">925</h3>
            ...
            >
              <div
                class="single"
                style="background-image: linear-gradient(#40f5ff, #fffeab)"
              >
                <div class="inner">
                  <h3 class="count counter">10,000</h3>
                  <p class="text">Jobs</p>
                </div>
              </div>
            </div>
            ...
            >
              <div
                class="single"
                style="background-image: linear-gradient(#40f5ff, #bb6eff)"
              >
                <div class="inner">
                  <h3 class="count counter">20,000</h3>
                  <p class="text">People Registered</p>
                </div>
              </div>
            </div>
            <div
            ...
            >
              <div
                class="single"
                style="background-image: linear-gradient(#40f5ff, #c2ff7d)"
              >
                <div class="inner">
                  <h3 class="count counter">200</h3>
        ...
        <p>
          Optimism is the faith that leads to achievement.<br> Nothing can be done without hope and confidence.
        </p>
        <br /><br />
        <a class="btn btn-danger" href="updatepass.jsp">Update Password</a>
        <form action="delete" method="post"><button class="btn btn-danger">Delete Account</button></form>
